...
class ClaseEngine():
    def __init__(self, OUTPUT_PATH):
        self.dataproc = SparkSession.builder.appName("BasicosNIF").getOrCreate()
        
        self.OUTPUT_PATH = OUTPUT_PATH
        
        self.rutaBase = '/content/drive/MyDrive/1. Básico/Caso de Uso 3/2.input/'
        self.ruta1 = self.rutaBase + 'planuno/'
        self.ruta2 = self.rutaBase + 'customers_ba/'
        self.ruta3 = self.rutaBase + 'bajas2021/'
    ...
    def to_csv(self):
        ...
        self.df_cuadrante_planuno.coalesce(1).write.parquet(self.csv_path_pyspark, mode="overwrite")
